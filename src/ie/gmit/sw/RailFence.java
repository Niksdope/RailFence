...
public class RailFence {
	...
	public String encrypt(String cypherText, int key){
		...
		// StringTokenizer to sift through the text and break it into valid strings (Hence all the delimiters)
		StringTokenizer st = new StringTokenizer(cypherText, " .!$%^&*(),+_-=[]#';/.,:{}~@?><|`\'\"\\");
		cypherText = "";
		while (st.hasMoreTokens())
		{
			cypherText += st.nextToken().toUpperCase();
		}
